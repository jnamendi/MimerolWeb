...
export class MenuHeaderComponent implements OnInit {
    ...
    private restaurantWorkTimeToDay: RestaurantWorkTimeModel = new RestaurantWorkTimeModel();
    ...
    onGetWorkTimeToDay = () => {
        ...
        let deliveryTimes = this.restaurantModel.restaurantWorkTimeModels;
        for (let item of deliveryTimes) {
            if (item.weekDay === stringDay) {
                this.restaurantWorkTimeToDay = item;
            }
        }
    }
}
